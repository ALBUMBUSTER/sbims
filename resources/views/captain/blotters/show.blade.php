...
<div class="container-fluid">
    ...
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="{{ route('captain.blotters.index') }}" class="btn-secondary">
    ...
    <div class="details-container">
        ...
        <div class="status-card">
            ...
            <div class="status-body">
                <form action="{{ route('captain.blotters.status', $blotter) }}" method="POST" class="status-form" id="statusForm">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="status-update-container">
                        ...
                        <button type="submit" class="btn-update-status" id="updateStatusBtn">
                        ...
                        <div class="resolution-grid">
                            <div class="form-group">
                                ...
                                <textarea name="resolution" id="resolution" class="form-control" rows="3"
                                    {{ $blotter->status == 'Settled' ? '' : 'disabled' }}>{{ old('resolution', $blotter->resolution) }}</textarea>
                            </div>
                            <div class="form-group">
                ...
                <div class="detail-body">
                    <div class="details-info-grid">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value">
                                {{ \Carbon\Carbon::parse($blotter->resolved_date)->format('F d, Y') }}
                            </span>
                        </div>
                        @endif
                    </div>
            ...
            <div class="detail-card full-width">
                ...
                <div class="detail-body">
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            <div class="timeline-date">{{ \Carbon\Carbon::parse($blotter->resolved_date)->format('M d, Y') }}</div>
                            <div class="timeline-content">
...
// Handle form submission with AJAX to prevent page refresh issues
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (statusForm) {
        statusForm.addEventListener('submit', function(e) {
            ...
            submitBtn.innerHTML = '<x-heroicon-o-arrow-path class="icon-small animate-spin" /> Updating...';
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Hide resolution field if not settled
