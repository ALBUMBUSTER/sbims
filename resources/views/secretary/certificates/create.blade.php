...
const purposeOptions = {
    'Clearance': [
        'Employment Application(Aplikasyon sa Trabaho)',
        'Local Employment(Lokal nga Trabaho)',
        'Overseas Employment (OFW)',
        'Business Permit Application(Aplikasyon sa Business Permit)',
        'School Enrollment(Aplikasyon sa Eskwela)',
        'Scholarship Application(Aplikasyon sa Scholarship)',
        'Travel Requirements(Mga Kinahanglanon sa Pagbiyahe)',
        'Bank Account Opening(Pagbukas sa Bank Account)',
        'Loan Application(Aplikasyon sa Loan)',
        'Government ID Application(Aplikasyon sa Government ID)',
        'Driver\'s License Application(Aplikasyon sa Driver\'s License)',
        'Passport Application(Aplikasyon sa Pasaporte)',
        'Visa Application(Aplikasyon sa Visa)',
        'Civil Service Eligibility(Aplikasyon sa Civil Service Eligibility)',
        'Job Promotion(Promosyon sa Trabaho)',
        ...
        'Marriage License Application(Aplikasyon sa Marriage License)',
        'Court Requirement(Mga Kinahanglanon sa Korte)',
        'Notarial Document Requirement(Mga Kinahanglanon sa Notaryo)',
    ],
    'Indigency': [
        'Medical Assistance(Financial Aid sa Medikal nga Tabang)',
        'Hospital Bill Assistance(Tabang sa Hospital Bill)',
        'Financial Assistance from LGU(Pinansyal nga Tabang gikan sa LGU)',
        'Scholarship Grant (Financial Aid)',
        'Social Welfare Programs (4Ps)',
        'Food Assistance(Tabang sa Pagkaon)',
        'Burial Assistance(Tabang sa Libing)',
        'Medicine Assistance(Tabang sa Medisina)',
        'Senior Citizen Benefits(Mga Benepisyo sa Senior Citizen)',
        'PWD Benefits(Mga Benepisyo sa PWD)',
        'Solo Parent Benefits(Mga Benepisyo sa Solo Parent)',
        'Disaster Relief Assistance(Tabang sa Kalamidad)',
        'Educational Assistance(Tabang sa Edukasyon)',
        'Livelihood Program Application(Aplikasyon sa Programa sa Panginabuhian)',
        'Housing Assistance(Tabang sa Pabahay)',
        'Utility Bill Discount Application(Aplikasyon sa Diskwento sa Utility Bill)',
        'Legal Aid Qualification(Kwalipikasyon sa Legal Aid)',
        'Free Legal Assistance(Libre nga Legal nga Tabang)',
        'Public Attorney\'s Office (PAO) Assistance',
        'Health Center Services(Serbisyo sa Health Center)',
        'Government Hospital Charity Ward(Charity Ward sa Government Hospital)',
        'DSWD Programs(Mga Programa sa DSWD)',
        'Food Stamp Program(Programa sa Food Stamp)',
        'Tulong Panghanapbuhay sa Ating Disadvantaged/Displaced Workers (TUPAD)',
        'Emergency Cash Assistance(Tulong Pinansyal sa Emerhensiya)',
    ],
    'Residency': [
        'Proof of Residency Requirement(Mga Kinahanglanon sa Patunay sa Paninirahan)',
        'Voter\'s Registration(Rehistro sa Botante)',
        'School Enrollment (Transfer Students)',
        'Local Employment (Proof of Residency)',
        'Business Registration(Proof of Address)',
        'Barangay ID Application(Aplikasyon sa Barangay ID)',
        'Tax Identification Number (TIN) Application',
        'Postal ID Application(Aplikasyon sa Postal ID)',
        'Driver\'s License',
        'Voter\'s ID Application(Aplikasyon sa Voter\'s ID)',
        'Senior Citizen ID Application(Aplikasyon sa Senior Citizen ID)',
        'PWD ID Application(Aplikasyon sa PWD ID)',
        'Utility Connection Application (Water/Electricity)',
        'Internet Connection Application(Aplikasyon sa Internet Connection)',
        'Bank Account Address Verification',
        'Loan Application (Address Verification)',
        'Credit Card Application(Aplikasyon sa Credit Card)',
        'Insurance Application(Aplikasyon sa Insurance)',
        'Government Service Eligibility(Eligibility sa Serbisyo sa Gobyerno)',
        'Residency Verification for Court Cases(Kumpirmasyon sa Paninirahan para sa mga Kaso sa Korte)',
        'Adoption Requirements(Mga Kinahanglanon sa Pag-aampon)',
        'Foster Care Application(Aplikasyon sa Foster Care)',
        'Relocation/Transfer Verification(Kumpirmasyon sa Relokasyon/Transfer)',
        'Community Tax Certificate (Cedula) Application',
        'Barangay Assembly Participation(Paglahok sa Barangay Assembly)',
    ]
};
